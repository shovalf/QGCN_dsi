...
def run_trial(dict_params):
    ...
    #model = QGCN(dict_params, ds.len_features, ext_train.len_embed())
    ...
    model = QGCN(dict_params, ds.len_features, [10], init_layers=dict_params["model"]["init_layers"])
...
if __name__ == "__main__":
    params_file = "../params/proteins_small_params.json"
    main(params_file)
