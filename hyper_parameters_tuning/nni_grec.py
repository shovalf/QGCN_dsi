...
def create_params_dict(params_file, nni_params):
    ...
    dict_params["model"]["optimizer"] = nni_params["optimizer"]
    ...
    dict_params["activator"]["epochs"] = 400
...
def run_trial(dict_params):
    ...
    activator.train(show_plot=False, early_stop=False, wait=dict_params["activator"]["wait"])
